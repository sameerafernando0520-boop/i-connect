  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: _KpiCard(label: 'Avg Attendance', value: '${avgAtt.toStringAsFixed(1)}%', icon: Icons.event_available_rounded, color: AdminColors.accent)),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _miniStat('Att ${att.toStringAsFixed(0)}%', AdminColors.accent),
                    const SizedBox(width: 8),
      ...
      child: Column(
        children: [
          ...
          Wrap(
            ...
            children: [
              if (high > 0) _legend('≥80% (Good)', AdminColors.accent),
              if (medium > 0) _legend('60–79% (Fair)', AdminColors.warning),
              if (low > 0) _legend('<60% (Poor)', StatusColors.danger),
              if (noData > 0) _legend('No Data', AdminColors.textSecondary),
            ],
          ),
        ],
      ),
    ...
    return ListView(
      ...
      children: [
        _TrendCard(
          ...
          legend: [
            _TrendLegendItem(label: 'Attendance', color: AdminColors.accent),
    ...
    return ListView(
      ...
      children: [
        _TrendCard(
          ...
          legend: [
            _TrendLegendItem(label: 'Avg Attendance', color: AdminColors.accent),
