...
const _typeColors = <String, Color>{
  ...
  'ticket_assigned':      StatusColors.indigo,
  'engineer_dispatch':    Brand.lightGreenDark,
  'schedule_created':     StatusColors.teal,
  'schedule_confirmed':   StatusColors.resolved,
  'schedule_cancelled':   AdminColors.error,
  'schedule_reminder':    AdminColors.warning,
  'leave_approved':       Brand.lightGreenDark,
...
class _EaNotificationsPageState extends State<EaNotificationsPage> {
  ...
  Color _colorForType(String? type) =>
      _typeColors[type ?? 'system'] ?? StatusColors.gray;
